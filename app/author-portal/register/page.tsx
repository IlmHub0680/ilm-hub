  ...
  if (submitted) {
    return (
      <div className="p-8 max-w-md mx-auto text-center">
        ...
        <p className="mt-2">Your application to 'Sell Your Books' is pending admin approval. Once approved, you can log in to your author portal.</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-8 max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button type="submit" className="w-full bg-blue-600 text-white p-2 rounded hover:bg-blue-700">Submit Author Application</button>
      </form>
    </div>
  );
}
