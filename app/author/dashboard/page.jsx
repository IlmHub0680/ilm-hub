      ...
      <div style={{ maxWidth: '1200px', margin: '32px auto', padding: '0 20px' }}>
        <div style={{ marginBottom: '28px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            <button onClick={() => setShowCouponModal(true)} style={{ backgroundColor: '#ffffff', color: '#14532d', border: '1px solid #14532d', padding: '10px 16px', borderRadius: '8px', fontWeight: 'bold', fontSize: '14px', cursor: 'pointer' }}>??? Create Coupon</button>
        ...
        <div style={{ display: 'flex', gap: '8px', borderBottom: '2px solid #e2e8f0', marginBottom: '24px' }}>
          ...
          <button onClick={() => setActiveTab('coupons')} style={{ padding: '12px 20px', border: 'none', background: 'none', fontWeight: 'bold', fontSize: '15px', color: activeTab === 'coupons' ? '#14532d' : '#64748b', borderBottom: activeTab === 'coupons' ? '3px solid #14532d' : 'none', cursor: 'pointer' }}>??? Coupons</button>
              ...
              <tbody>
                {manuscripts.map((item, idx) => (
                  <tr key={idx} style={{ borderBottom: '1px solid #f1f5f9' }}>
                    ...
                    <td style={{ padding: '16px 20px', color: '#2563eb' }}>??? {item.coverUrl}</td>
        ...
        {activeTab === 'sales' && (
          <div style={{ backgroundColor: '#ffffff', borderRadius: '10px', border: '1px solid #e2e8f0', overflow: 'hidden' }}>
            <div style={{ padding: '16px 20px', backgroundColor: '#f0fdf4', borderBottom: '1px solid #bbf7d0', color: '#166534', fontSize: '13px' }}>
              ?? Payments go to Admin first. Customer download links unlock automatically upon payment approval, and payouts are calculated at 70% author royalty.
            </div>
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '14px' }}>
              <thead>
                <tr style={{ backgroundColor: '#f1f5f9', color: '#475569', textTransform: 'uppercase', fontSize: '12px' }}>
