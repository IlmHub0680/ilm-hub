    ...
    <div style={{ fontFamily: 'Arial, sans-serif', backgroundColor: '#f8fafc', color: '#14532d', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      ...
      <section style={{ textAlign: 'center', padding: '80px 20px', backgroundColor: '#14532d', color: '#ffffff' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '15px', flexWrap: 'wrap' }}>
              <Link href="/admission" style={{ padding: '12px 24px', borderRadius: '8px', textDecoration: 'none', backgroundColor: '#16a34a', color: '#ffffff', fontWeight: 'bold', fontSize: '16px' }}>
                  Apply For Admission
              </Link>
              <Link href="/author-portal/admission" style={{ padding: '12px 24px', borderRadius: '8px', textDecoration: 'none', backgroundColor: 'transparent', color: '#ffffff', border: '1px solid #ffffff', fontWeight: 'bold', fontSize: '16px' }}>
                  Sell Your Books
              </Link>
      ...
      <section style={{ maxWidth: '1100px', margin: '60px auto', padding: '0 20px' }}>
        <h3 style={{ fontSize: '26px', color: '#14532d', textAlign: 'center', marginBottom: '10px' }}>Academic Programme</h3>
